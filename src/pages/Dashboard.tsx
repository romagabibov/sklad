...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <header className="h-auto md:h-16 bg-white border-b border-slate-200 px-6 py-4 md:py-0 flex flex-col md:flex-row items-start md:items-center justify-between -mx-6 -mt-6 mb-6 gap-4">
